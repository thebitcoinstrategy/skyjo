import type { VisibleGameState } from './game.js';
...
export type AnimationEventType = 'deal' | 'flip-card' | 'draw-from-pile' | 'draw-from-discard' | 'place-card' | 'discard-card' | 'column-eliminate' | 'round-end' | 'game-end';
