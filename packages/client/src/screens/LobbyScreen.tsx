  ...
  return (
    <div className="h-full flex flex-col items-center p-6 relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% 30%, transparent 30%, rgba(0,0,0,0.35) 100%)' }}
      />
      ...
      <div className="relative z-10 w-full max-w-xs flex flex-col h-full">
          ...
          <div ref={listRef} className="space-y-2">
            {lobby.map((player) => (
              ...
              >
                ...
                <span className="text-white font-medium flex-1 text-base">{player.nickname}</span>
                {player.isHost && (
        ...
        <div className="space-y-2 pb-2">
          {isHost && (
            ...
            >
              {canStart ? 'Spiel starten' : 'Mind. 2 Spieler'}
            </button>
          )}
          {!isHost && (
