...
5. `scp /tmp/skyjo-deploy.tar.gz root@168.144.44.168:/opt/skyjo-deploy.tar.gz`
6. `ssh root@168.144.44.168 "cd /opt/skyjo && rm -rf packages tsconfig.base.json && tar -xzf /opt/skyjo-deploy.tar.gz && rm /opt/skyjo-deploy.tar.gz && docker compose -f docker-compose.prod.yml up --build -d"`
